...
$sql="SELECT * from hotel_jayed where id=$hotel_id";
					...
					<div role="tabpanel" class="tab-pane fade in active" id="Overview">
						...
						<div class="row">
							<div class="tr-single-box">
								...
								<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBwYP7_S0gQ3h_JuLbrT3Svq7-1OcJOVHQ&callback=initMap">
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBwYP7_S0gQ3h_JuLbrT3Svq7-1OcJOVHQ & callback=myMap"></script>
