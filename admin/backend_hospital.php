...
if(isset($_POST['readrecords'])){
	...
	$displayquery = " SELECT * FROM hospital_jayed"; 
...
if(isset($_POST['place_name'])  )
   ...
   $query  = "Insert into hospital_jayed (place_name,hospital_name,address,contact_no) VALUES ('$place_name','$hospital_name','$address','$contact_no')";
...
if(isset($_POST['deleteid']))
{
	...
	$deletequery = " delete from hospital_jayed where id ='$user_id' ";
